...
export default function Header(props) {
    ...
    const isSticky = (e) => {
        ...
        scrollTop >= 150 ? nav.classList.add('is-sticky') : nav.classList.remove('is-sticky');
    };
    return (
        <header className='px-0'>
            <nav className="navbar navbar-expand-lg navbar-dark" style={{ padding: '0 5rem' }}>
                ...
                <div className="d-flex align-items-center" style={{ listStyle: 'none' }}>
                    <div>
                        <a className="text-light" href="#" style={{ borderRadius: '1.25rem', cursor: 'pointer' }}>Đón tiếp khách</a>
                    </div>
            ...
            <div className='mt-2'>
                <div className='search-blog'>
                    <div className='d-flex mx-0 text-dark font-weight-bold'>
                        <div className="col-3">
                            <label className="mt-2" style={{ marginLeft: '15px' }}>Địa điểm</label>
                            ...
                            <div className='mt-3'
                                ...
                                {suggestions && suggestions.map((item, index) => {
                                    return <>
                                        <li className="list-group-item font-weight-lighter border-0"
                                            style={{
                                                width: '350px',
                                                fontSize: '18px'
                                            }}
                        ...
                        <div className="col-3 " >
                            ...
                            <input type="date" className="form-control border-0 p-0"
                                style={{ width: '70%', marginTop: '-15px', borderStyle: 'solid' }}
                                id="exampleInputEmail1"
                                placeholder='Thêm ngày' />
                        </div>
                        <div className="col-3 ">
                            <label className="mt-2 ">Trả phòng</label>
                            <input type="date" className="form-control border-0 p-0 h-0 "
                        ...
                        <div className="col-3 ">
                            <div className='row'>
                                <div className='col-8'>
                                    ...
                                    <input type="number" className="form-control border-0 p-0 h-0"
