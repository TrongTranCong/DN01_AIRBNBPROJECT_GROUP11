...
export default function DanhSachPhong(props) {
    const { arrDanhSachPhong } = useSelector(state => state.DanhSachPhongReducer);
            ...
            return <>
                ...
                <div className="col-md-6 border-bottom">
                    <div className="card-body" style={{ padding: '0.25rem 1rem' }}>
                        ...
                        <p className="card-text">Khách: {item.guests} , Phòng ngủ: {item.bedRoom}</p>
                        <p className="card-text font-weight-bold">Giá:{item.price} $/đêm</p>
                    </div>
                </div>
            </>
        })
                ...
                <div className="row justify-content-center px-5 py-3">
                    <div className='col-3'>
                        <a className="navbar-brand" href="#">
                            <div className="row mx-0 align-items-center">
                                ...
                                <div className='pl-1 font-weight-normal'
                                    style={{
                                        fontSize: '2rem',
                                        color: 'rgb(255, 56, 92)'
                                    }}>airbnb</div>
                    ...
                    <div className=" nav_DSP col-6">
                        <div className="d-flex text-center"
                            ...
                            <div className='col-5'>
                                <input className='form-control text-center' style={{ border: 'transparent' }} type='text' placeholder='Khu vực bạn đã chọn' />
                            </div>
                            <div className='col-3 border-left'>
                                <input className='form-control text-center' style={{ border: 'transparent' }} type='text' placeholder='Thêm ngày' />

                            </div>
                            <div className='col-3 border-left'>
                                <input className='form-control text-center' style={{ border: 'transparent' }} type='text' placeholder='Thêm khách' />
                            </div>
                            <div className="col-1">
                                <div className
                                    style={{
